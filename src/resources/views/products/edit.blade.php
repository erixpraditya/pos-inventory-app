            ...
            <div class="p-6">
                ...
                <form action="{{ route('products.update', $product) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-5">
                        <div class="relative">
                            ...
                            <div class="flex gap-2">
                                <input type="text" class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition @error('code') border-red-500 @else border-gray-300 @enderror" id="code" name="code" value="{{ old('code', $product->code) }}" required>
                        ...
                        <div>
                            ...
                            <input type="text" class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition @error('name') border-red-500 @else border-gray-300 @enderror" id="name" name="name" value="{{ old('name', $product->name) }}" required>
                             @error('name')
                                <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-5">
                        ...
                        <div>
                            ...
                            <div class="flex">
                                ...
                                <input type="number" class="w-full px-4 py-2 border rounded-r-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition @error('price') border-red-500 @else border-gray-300 @enderror" id="price" name="price" value="{{ old('price', $product->price) }}" required min="0">
                            </div>
                             @error('price')
                                <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="number" class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition @error('stock') border-red-500 @else border-gray-300 @enderror" id="stock" name="stock" value="{{ old('stock', $product->stock) }}" required min="0">
                             @error('stock')
                                <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="mb-6">
                        ...
                        @if($product->image)
                            <div class="mb-3">
                                <img src="{{ asset('storage/' . $product->image) }}" class="rounded-lg h-24 w-24 object-cover shadow-sm">
                            </div>
                        @endif
                    ...
                    <div class="flex justify-end gap-3">
                        ...
                        <button type="submit" class="px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition shadow-sm">Update Product</button>
                    </div>
                </form>
            </div>
        </div>
